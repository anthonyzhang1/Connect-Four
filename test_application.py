...
def test_check_for_win_in_row(logic: Logic) -> None:
    ...
    assert logic.game_is_won == True, "The game did not have a row winner."
...
def test_check_for_win_in_column(logic: Logic) -> None:
    ...
    # Checks that the game is won.
    assert logic.game_is_won == True, "The game did not have a column winner."
...
def test_check_for_win_in_ascending_diagonal(logic: Logic) -> None:
    ...
    # Checks that the game is won.
    assert logic.game_is_won == True, "The game did not have an ascending diagonal winner."
...
def test_check_for_win_in_descending_diagonal(logic: Logic) -> None:
    ...
    # Checks that the game is won.
    assert logic.game_is_won == True, "The game did not have a descending diagonal winner."